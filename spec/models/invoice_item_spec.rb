...
RSpec.describe InvoiceItem do
  ...
  describe 'class methods' do
    it '.invoice_items_show returns all items for a given merchants invoice id' do
    ...
    describe 'instance methods' do
      it '#discount_applied returns id of the discount applied to an invoice_item, if any' do
      ...
      it '#numeric_status returns the status of the invoice item as an integer for select menu' do
        merchant = Merchant.create!(name: 'Schroeder-Jerde')
