...
RSpec.describe 'Merchant\'s Bulk Discount edit', type: :feature do
  before :each do
    ...
    @discount_2 = @merchant.bulk_discounts.create!(percentage: 20.0, quantity_threshold: 20)
    ...
    @invoice_item_2 = InvoiceItem.create!(quantity: 20, unit_price: 5000, item_id: @item_2.id, invoice_id: @invoice_2.id, status: 1)
